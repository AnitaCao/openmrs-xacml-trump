...
public class Context {
	...
	public static boolean hasPrivilege(String privilege, boolean admin) {
	...
	public static PolicyService getPolicyService() {
		return getServiceContext().getPolicyService();
	}
	
	public static EnforceService getEnforceService() {
		return getServiceContext().getEnforceService();
	}
	
	public static DecesionService getDecesionService() {
		return getServiceContext().getDecesionService();
	}
