...
public class ServiceContext implements ApplicationContextAware {
	...
	public PolicyService getPolicyService() {
		return getService(PolicyService.class);
	}
	...
	public void setPolicyService(PolicyService policyService) {
		setService(PolicyService.class, policyService);
	}
	...
	public EnforceService getEnforceService() {
		return getService(EnforceService.class);
	}
	...
	public void setEnforceService(EnforceService enforceService) {
		setService(EnforceService.class, enforceService);
	}
	 ...
	 * @return
	 */
	public DecesionService getDecesionService() {
		return getService(DecesionService.class);
	}
	
	/**
	 * 
	 * @param decesionService
	 */
	public void setDecesionService(DecesionService decesionService) {
		setService(DecesionService.class, decesionService);
	}
