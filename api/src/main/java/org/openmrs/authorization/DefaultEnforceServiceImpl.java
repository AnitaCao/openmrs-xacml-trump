...
public class DefaultEnforceServiceImpl implements EnforceService {
	...
	private RequestType generateRequest(String priviledge, User user) throws Exception {
		...
		subjectRoleAttribute.setDataType(new StringDataTypeAttribute());
		...
		subjectUserAttribute.setDataType(new StringDataTypeAttribute());
		...
		currentTime.setDataType(new TimeDataTypeAttribute());
	...
	private DataTypeAttribute<?> getXACMLDataType(String dataType) throws Exception {
		// NOTE: This could cause bad problems.
		DataTypeAttribute<?> xacmlDataType = null;
		
		if (dataType.equals("integer")) {
			xacmlDataType = new IntegerDataTypeAttribute();
		}
		
		if (dataType.equals("double")) {
			xacmlDataType = new DoubleDataTypeAttribute();
		}
